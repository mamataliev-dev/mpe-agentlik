  ...
  <div>
    ...
    >
      ...
      <div class="flex flex-col gap-y-[27px] px-[32px] py-[58px]">
        <div class="flex flex-col gap-y-[14px]">
          <span v-html="data?.short_text" class="w-[458px] text-[#5D5D5F]"
            ></span
          >
          <h1
...
const { data } = await useAsyncData('centralAppratusId', () => useAgency().getAgency(`/regional_administrations/${route.params.id}`));
